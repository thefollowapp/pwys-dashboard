...
def get_summary(db: Session, days: int | None = 30, location: str | None = None) -> dict:
    ...
    move_indoors_sent = _sent_by_type("move_indoors")
    practice_on_sent = _sent_by_type("practice_on")
    ...
    return {
        ...
        "move_indoors_sent": move_indoors_sent,
        "practice_on_sent": practice_on_sent,
